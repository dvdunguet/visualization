...
<script type='text/javascript' src=\"data/dataDygraphs.php?graphid=".$_SESSION['graphid']."&datatype=".$_SESSION['datatype'].'&startDate='.$_SESSION['startDate'].'&endDate='.$_SESSION['endDate']. "\" ></script>";
